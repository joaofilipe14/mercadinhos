package pt.devoteam.pagamentos.kafka;

import com.fasterxml.jackson.databind.ObjectMapper;
import org.springframework.kafka.annotation.KafkaListener;
import org.springframework.stereotype.Component;
import pt.devoteam.pagamentos.event.CandidaturaAprovadaEvent;
import pt.devoteam.pagamentos.event.PerfilAtivadoEvent;
import pt.devoteam.pagamentos.event.UtilizadorRegistadoEvent;
import pt.devoteam.pagamentos.service.EmailService;
...
public class NotificacaoKafkaListener {
    ...
    public void ouvirAprovacaoFeira(String mensagemBruta) {
        try {
            ...
            emailService.enviarEmailCandidaturaAprovada(
                    evento.emailFeirante(),
                    evento.nomeFeirante(),
                    evento.nomeMercado(),
